        ...
        <section className="section-padding pb-5">
            <div className="container">
                ...
                <div className="row">
                            ...
                            <div className="product-content-wrap">
                                ...
                                <div className="deals-content">
                                    <h2><a
                                        ...
                                        of Change Organic Quinoa, Brown,
                                        &
                                        Red Rice</a></h2>
                    ...
                    <div
                        className="col-xl-3 col-lg-4 col-md-6 d-none d-lg-block">
                        <div
                            className="product-cart-wrap style-2 wow animate__animated animate__fadeInUp"
                            data-wow-delay=".2s">
                            <div className="product-img-action-wrap">
                            ...
                            <div className="product-content-wrap">
                                ...
                                <div className="deals-content">
                                    <h2><a
                                        href="shop-product-right.html">Signature
                                    ...
                                    <div className="product-rate-cover">
                                        ...
                                        <span
                                            className="font-small ml-5 text-muted"> (3.0)</span>
                                    </div>
                                    <div>
                                            <span
                                                className="font-small text-muted">By <a
                    ...
                    <div
                        className="col-xl-3 col-lg-4 col-md-6 d-none d-xl-block">
                        <div
                            className="product-cart-wrap style-2 wow animate__animated animate__fadeInUp"
                            data-wow-delay=".3s">
                            <div className="product-img-action-wrap">
                            ...
                            <div className="product-content-wrap">
                                ...
                                <div className="deals-content">
                                    <h2><a
                                        href="shop-product-right.html">Simply
