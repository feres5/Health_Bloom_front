...
function IndexNavbar() {
  ...
  const getUserInfo = async () => {
    const reponse = await fetch(url + `getById/${decodedTOKEN.user_id}`);
    const jsonRes = await reponse.json();
    if (jsonRes.doctor.Status === "Confirmed") setIsConfirmed(true);
  };
  ...
  async function changePassword() {
    ...
    if (newPassword === confirmNewPassword) {
      let result = await fetch(url + "changePassword/" + decodedTOKEN.user_id, {
        method: "POST",
        headers: {
    ...
    } else alert("password and confirm password needs to be the exact same");
  }
  return token ? (
    <>
      {collapseOpen ? (
            ...
            <Nav navbar>
              ...
              <UncontrolledDropdown nav>
                ...
                <DropdownMenu right>
                  ...
                  <DropdownItem onClick={handleClickOpen}>
                    change password
                  </DropdownItem>
                  <div className="divider"></div>
